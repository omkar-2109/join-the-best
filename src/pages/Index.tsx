...
const testimonials = [
  {
    ...
    quote: "BBS helped me land my dream role within two weeks. The process was seamless and completely transparent.",
    avatar: "AM",
  },
  {
    name: "Sneha Patil",
    role: "Marketing Professional",
    quote: "I loved that I could focus on the role itself without any bias. The platform team kept me updated at every step.",
    avatar: "SP",
  },
  {
    name: "Rahul Verma",
    role: "Data Analyst",
    quote: "The application tracker made it so easy to see where I stood. Highly recommend BBS to anyone looking for quality opportunities.",
    avatar: "RV",
  },
];
...
const FeaturedRolesSection = () => {
  const jobs = getActiveJobs().slice(0, 6);
      ...
      <section className="bg-secondary py-16 lg:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button className="mt-6" variant="outline" asChild>
            <Link to="/jobs">Browse All Roles</Link>
          </Button>
        </div>
      </section>
    );
              ...
              <CardContent className="p-5">
                ...
                <div className="mt-4">
                  <Button variant="ghost" size="sm" className="h-7 text-xs text-primary" asChild>
                    <Link to={`/jobs/${job.id}`}>
                      Apply via Platform <ArrowRight className="ml-1 h-3 w-3" />
                    </Link>
                  </Button>
                </div>
              </CardContent>
  ...
  <section className="gradient-navy py-16">
    <div className="container mx-auto px-4 text-center">
      ...
      <p className="mx-auto mb-8 max-w-lg text-primary-foreground/70">
        Register today and let BBS connect you with the right opportunities. No bias, no noise — just the right match.
      </p>
